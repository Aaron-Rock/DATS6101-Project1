...
ggplot(westcoast_annualClean, aes(x=November.2010)) + geom_boxplot(color="blue", outlier.shape = 9, outlier.size = 2, outlier.color = "blue") + labs(title="Entire West Coast November 2010 Boxplot without Outliers")
...
ggplot(westcoast_annualClean, aes(x=November.2016)) + geom_boxplot(color="blue", outlier.shape = 9, outlier.size = 2, outlier.color = "blue") + labs(title="Entire West Coast November 2016 Boxplot without Outliers")
```
...
ggplot(eastcoast_annualClean, aes(x=November.2010)) + geom_boxplot(color="blue", outlier.shape = 9, outlier.size = 2, outlier.color = "blue") + labs(title="Entire East Coast November 2010 Boxplot without Outliers")
...
ggplot(eastcoast_annualClean, aes(x=November.2016)) + geom_boxplot(color="blue", outlier.shape = 9, outlier.size = 2, outlier.color = "blue") + labs(title="Entire East Coast November 2016 Boxplot without Outliers")
```

## Scatter plot of West Coast
```{r, results='asis'}
ggplot(westcoast_annual, aes(November.2010,November.2016, color=State)) + geom_point() + labs(title="West Coast Scatterplot between November 2010 and November 2016 with Outliers", x = "November.2010 Rent Prices", y = "November.2016 Rent Prices")
ggplot(westcoast_annualClean, aes(November.2010,November.2016, color=State)) + geom_point() + labs(title="West Coast Scatterplot between November 2010 and November 2016 without Outliers", x = "November.2010 Rent Prices", y = "November.2016 Rent Prices")
```

## Scatter plot of East Coast
```{r, results='asis'}
ggplot(eastcoast_annual, aes(November.2010,November.2016, color=State)) + geom_point() + labs(title="East Coast Scatterplot between November 2010 and November 2016 with Outliers", x = "November.2010 Rent Prices", y = "November.2016 Rent Prices")
ggplot(eastcoast_annualClean, aes(November.2010,November.2016, color=State)) + geom_point() + labs(title="East Coast Scatterplot between November 2010 and November 2016 without Outliers", x = "November.2010 Rent Prices", y = "November.2016 Rent Prices")
```
...
west2010_95 = t.test(x=westcoast_annualClean$November.2010)
west2010_95
west2016_95 = t.test(x=westcoast_annualClean$November.2016)
west2016_95
...
east2010_95 = t.test(x=eastcoast_annualClean$November.2010)
east2010_95
east2016_95 = t.test(x=eastcoast_annualClean$November.2016)
east2016_95
